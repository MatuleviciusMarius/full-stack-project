...
export default function Module4() {
  return (
    <div className="justify-text color">
      ...
      <p>
        Mintys atsiranda dėl sudėtingų protinių procesų, kurie apima informacijos suvokimą,
        apdorojimą ir interpretaciją. Mūsų protas gauna informaciją iš aplinkos, perduodamą per
        jutimus, patirtį ir mokymąsi. O ši apdorojama mūsų smegenyse, jungiama su jau turima
        informacija.
      </p>

      <p>
        Mintys gali atsirasti iš skirtingų šaltinių. Kartais jos gali būti tiesiogiai susijusios su
        tuo, ką mes stebime ar patiriame realiame pasaulyje. Jos gali būti paskatintos atsirasti dėl
        išorinių įspūdžių, dėl pokalbių su kitais žmonėmis arba iš tiesioginio patyrimo dalyvaujant
        kokiame nors gyvenimo įvykyje.
      </p>

      <p>
        Tačiau mintys gali atsirasti ir iš vidinės veiklos. Jos gali kilti iš mūsų prisiminimų,
        vaizduotės, intuicijos ar abstrakčios minties procesų. Dažnai mintys susijusios su problemų
        sprendimu, kūrybiškumu arba naujų idėjų generavimu.
      </p>

      <p>
        Mintys gali būti veikiamos ir mūsų emocinės būsenos. Pavyzdžiui, tam tikros emocijos gali
        paskatinti mus susimąstyti apie tam tikrus dalykus arba leisti mums suvokti situacijas iš
        naujos perspektyvos.
      </p>
      ...
      <p>
        Vis dėlto, nors žmonės ir yra savo minčių autoriai, kartais mintys gali atsirasti ir
        atrodyti netikėtai ar net be sąmonės kontrolės. Tai susiję su pasąmonės procesais.
      </p>
      ...
      <p>
        ...
        netgi visą mąstymą. O gal bandei kontroliuoti mintis ar išvis jas sustabdyti? Ir kiek laiko
        pavyko kontroliuoti mintis?
      </p>

      <p>
        Pats efektyviausias įrankis, kuris iš tikro daro įtaką žmogaus mąstymui ir asmeniniam
        augimui yra Jėzuitų ordino narių XVI amžiuje sukurtas įrankis. Šis įrankis plačiai
        naudojamas ir garsėja tuo, kad padeda žmogui geriau pažinti ir suprasti save ir kitus,
        apmąstyti savo veiksmus, tobulinti savo elgesį ir priimti geriausius sprendimus. Šis metodas
        naudojamas ir psichologijoje, tik vadinamas kitaip. Jėzuitų metodas yra efektyvus, kadangi
        jis skatina sąmoningumą, refleksiją ir nuoseklų veiksmų planavimą.
      </p>

      <p>
        Dabar pateikiu pilną metodą, kad būtų paprasta jį suprasti ir naudoti. Metodas susideda iš 4
      ...
      <p>
        ...
        žingsniams dar ne laikas. Kai žinosi ko tikrai nori, tuomet ir bus laikas sekantiems
        žingsniams.
      </p>
